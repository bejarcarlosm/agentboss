        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-sm text-[var(--muted)] leading-relaxed text-center">
              To talk with {agent.name}, send the word <strong className="text-[var(--foreground)]">AGENT</strong> via WhatsApp. We'll reply with an access link.
            </p>
